...
public:
    ...
    static stTransferRegisterRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferRegisterRecord.srcBalance = stoi(TransferRegisterDataLine[4]);
        TransferRegisterRecord.desBalance = stoi(TransferRegisterDataLine[5]);
    ...
    static  vector <stTransferRegisterRecord> GetTransferLogList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                TransferRegisterRecord = _ConvertTransferLogLineToRecord(Line);
    ...
    string _PrepareTransferRecord(double Amount, clsBankClient& DestinationClient, string Username,string Seperator = "#//#")
    {
        ...
        TransferRecordString += clsDate::GetSystemDateTimeString() + Seperator;
        TransferRecordString += _AccountNumber + Seperator;
        TransferRecordString += DestinationClient.AccountNumber() + Seperator;
        TransferRecordString += to_string(Amount) + Seperator;
        TransferRecordString += to_string(_AccountBalance) + Seperator;
        TransferRecordString += to_string(DestinationClient.AccountBalance) + Seperator;
        TransferRecordString += Username ;
        return TransferRecordString;
    }
