...
int CountNegativeNumbersInArray(vector<int> array) {
	int counter = 0;
	for (int i = 0; i < array.size(); i++)
	{
		if (array[i] < 0)
...
int main()
{
	...
	int negativeNumbersCount = CountNegativeNumbersInArray(array);

	cout << "the number of negative numbers : " << negativeNumbersCount << endl;
